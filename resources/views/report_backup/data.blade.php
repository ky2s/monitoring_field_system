                        ...
                        <div class="col-md-6">
                        	...
                        	@else
                        		...
                        		<span class="icontainer">
								  	<a href="{{ Storage::disk('spaces')->url($d->form_id.'/'.$data[0]->{$namefield}) }}" target="_blank">Display Image</a>
									<img height="200" class="manImg" src="{{ Storage::disk('spaces')->url($d->form_id.'/'.$data[0]->{$namefield}) }}">
								</span>
	                        	@endif
                        	@endif
