...
@section('header')
 <div class="col-md-5">
    <h1>Create Rules <small>-- {{$form->label}} <small>-- {{$form->form->name}}</small></small></h1>
</div>
<div class="col-md-7">
    <ol class="breadcrumbs">
        <li><a href="{{route('home')}}"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="{{route('projectlist')}}"><i class="fa fa-dashboard"></i> Project</a></li>
        <li><a href="{{route('formgrouplist', $formid)}}"><i class="fa fa-dashboard"></i> Form List</a></li>
        <li><a href="{{route('formdetaillist', $form->form->id)}}"><i class="fa fa-dashboard"></i> {{$form->form->name}}</a></li>
        <li><a href="{{route('formgrouplist', $form->id)}}"><i class="fa fa-dashboard"></i> {{$form->label}}</a></li>
    </ol>
</div>
@endsection
        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form action="{{URL::route('formgroupupdaterule', [$detailid, $formid])}}" class="form-horizontal" id="fcp" method="post">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group" style="padding-left:10px">
                            ...
                            <div class="col-md-2" style="width:100px;">
                                ...
                                <a href="{{URL::route('formgroupdestroyrule', [$detailid, $formid] )}}" onclick="event.preventDefault();
...
@foreach($detail->kondisi as $k)
<form id="hapus-form{{$k->id}}" action="{{ route('formgroupdestroyrule', [$detailid, $formid]) }}" method="POST" style="display: none;">
